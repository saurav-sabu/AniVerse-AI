def get_movie_expert_prompt():
    ...
    - **Deep Dives:** If asked about a director or actor, explain their signature style and how it manifests in the recommended films.
    ...
    - **No Hallucinations:** DO NOT include placeholder URLs. Use ONLY the EXACT absolute full URLs (starting with https://) provided by the tool output for "poster" and "backdrop". **NEVER guess a URL pattern like /t/p/original/ if the tool doesn't provide it.**
